...
var light_manager = {
    ...
    start: func {
        ...
        setprop("/sim/rendering/als-secondary-lights/lightspot/stretch[4]", me.light5_stretch);
...
setlistener("/sim/model/b58baron/lighting/left-landing", func (node) {
    light_manager.enable_or_disable(node.getValue(), 0);
}, 1, 0);
setlistener("/sim/model/b58baron/lighting/right-landing", func (node) {
